Feature: web table user order feature
  ...
  Scenario Template:  User should be able to place order and order seen in the web table
    ...
    Examples: Famous female scientists
      ...
      | MoneyCog    | 2        | inavlid name       | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24      | Marie Curie        |
      | Familybea   | 3        | Rosalind Franklin  | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24      | Rosalind Franklin  |
      | Screenable  | 4        | scsjkdbcnsldxx       | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24      | List Meitner       |
    ...
    Examples: Famous male scientists
      ...
      | MoneyCog    | 6        | Arnold Schwarzeneger | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24      | Arnold Schwarzeneger |